...
function __geodata()
   ...
   self.db.chronicles  =  {
                        ...
                        { zonename="Meridian", zonetype=" Chronicle", expansion=" Rift", zoneid="" },
   ...
   self.db.zones =  {
                  ...
                  { zonename="Ardent Domain", zonetype=" Normal", expansion=" Storm Legion", zoneid="" },
                  ...
                  { zonename="Ashora", zonetype=" Normal", expansion=" Storm Legion", zoneid="" },
                  { zonename="Cape Jule", zonetype=" Normal", expansion=" Storm Legion", zoneid="" },
                  { zonename="City Core", zonetype=" Normal", expansion=" Storm Legion", zoneid="" },
                  ...
                  { zonename="Droughtlands", zonetype=" Normal", expansion=" Rift", zoneid="" },
                  { zonename="Eastern Holdings", zonetype=" Normal", expansion=" Storm Legion", zoneid="" },
                  { zonename="Ember Isle", zonetype=" Normal", expansion=" Rift", zoneid="" },
                  { zonename="Freemarch", zonetype=" Normal", expansion=" Rift", zoneid="" },
                  { zonename="Gedlo Badlands", zonetype=" Normal", expansion=" Starfall Prophecy", zoneid="" },
                  { zonename="Gloamwood", zonetype=" Normal", expansion=" Rift", zoneid="" },
                  ...
                  { zonename="Iron Pine Peak", zonetype=" Normal", expansion=" Rift", zoneid="" },
                  { zonename="Kingdom of Pelladane", zonetype=" Normal", expansion=" Storm Legion", zoneid="" },
                  { zonename="Kingsward", zonetype=" Normal", expansion=" Storm Legion", zoneid="" },
                  { zonename="Mathosia", zonetype=" Normal", expansion=" Rift", zoneid="" },
                  { zonename="Meridian", zonetype=" Normal", expansion=" Rift", zoneid="" },
                  { zonename="Moonshade Highlands", zonetype=" Normal", expansion=" Rift", zoneid="" },
                  { zonename="Morban", zonetype=" Normal", expansion=" Storm Legion", zoneid="" },
                  { zonename="Planetouched Wilds", zonetype=" Normal", expansion=" Rift", zoneid="" },
                  { zonename="Sanctum", zonetype=" Normal", expansion=" Rift", zoneid="" },
                  { zonename="Scarlet Gorge", zonetype=" Normal", expansion=" Rift", zoneid="" },
                  { zonename="Scarwood Reach", zonetype=" Normal", expansion=" Rift", zoneid="" },
                  { zonename="Scatherran Forest", zonetype=" Normal", expansion=" Starfall Prophecy", zoneid="" },
                  { zonename="Seratos", zonetype=" Normal", expansion=" Storm Legion", zoneid="" },
                  { zonename="Shimmersand", zonetype=" Normal", expansion=" Rift", zoneid="" },
                  { zonename="Silverwood", zonetype=" Normal", expansion=" Rift", zoneid="" },
                  { zonename="Steppes of Infinity", zonetype=" Normal", expansion=" Storm Legion", zoneid="" },
                  { zonename="Stillmoor", zonetype=" Normal", expansion=" Rift", zoneid="" },
                  { zonename="Stonefield", zonetype=" Normal", expansion=" Rift", zoneid="" },
                  ...
                  { zonename="The Dendrome", zonetype=" Normal", expansion=" Storm Legion", zoneid="" },
